...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2021 at 03:20 PM
...
(1, 2, '0000-00-00', 0, 'LANGUAGE', 'INDIGENOUS PEOPLE', 'RELIGION', 'HOUSE NUM', 'BRGY', 'MUNICIPAL', 'PROVINCE', 'Nestor Ricafort', 'MOTHER NAME', 'GUARDIAN NAME', 'RELATIONSHIP', 'CONTACT', '2021-09-07 19:35:37');
...
(1, 17, '111', 'FUND SOURCE', 'POSITION', 'NATURE', 'DEGREE', 'MAJOR', 'MINOR', 'NONE');
...
(16, 'Paderogao', 'Phil Rey', 'Estrella', 'Male', 'admin', '!Password1', 5, 'SHS'),
(17, 'Ricafort', 'Sydney', 'Pacana', 'Male', 'syd123', '@Password123', 5, 'SHS');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_subjects_shs`  AS SELECT `subjects`.`id` AS `id`, `subjects`.`subjectCode` AS `subjectCode`, `subjects`.`description` AS `description`, `subjects`.`gradeLevel` AS `gradeLevel` FROM `subjects` WHERE `subjects`.`dep_type` = 'SHS' ORDER BY `subjects`.`gradeLevel` ASC ;
