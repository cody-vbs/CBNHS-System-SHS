...
//        mainTab.setFont(myVariables.TAB_HEADER_FONT);
    ...
    private void runModule(int index,boolean minimizeOpened){
        ...
        switch(index){
            case 1:{
                opened = my.runExeFile("modules/Registration_System__SHS_.jar",false);
                break;
            }case 2:{
                opened = my.runExeFile("modules/Enrollment_System__SHS_.jar",false);
                break;
            }case 3:{
                opened = my.runExeFile("modules/Attendance_System__SHS_.jar",false);
                break;
            }case 4:{
                opened = my.runExeFile("modules/Weighing_System_Final__SHS_.jar",false);
                break;
            }case 5:{
                opened = my.runExeFile("modules/Book_Keeping_System__SHS_.jar",false);
                break;
            }case 6:{
                opened = my.runExeFile("modules/Grading_System__SHS_.jar",false);
                break;
            }case 7:{
                opened = my.runExeFile("modules/Forms_System__SHS_.jar",false);
                break;
            }
        }
        if(minimizeOpened){
