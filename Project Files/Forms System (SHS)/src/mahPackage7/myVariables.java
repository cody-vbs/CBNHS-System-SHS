...
public class myVariables {
    ...
    private static final int [] enrollmentViewMinWBdateSHSWStrandOrder = new int [] {7,0,6,1,2,9,5,4,8,3};
    ...
    private static final int [] shsf5MinimalOrder=new int [] {13,4,8,7,3,0,9,14,2,15,1,10,5,6,11,12};
    private static final int [] shsf5MinimalOrder2=new int [] {13,4,8,7,3,0,9,14,2,15,1,10,5,6,11,12};
    
    private static final int [] jhsf5FullOrder=new int [] {15,6,8,14,10,13,4,3,16,9,5,0,11,17,2,18,1,12,7};
    private static final int [] shsf5FullOrder=new int [] {17,9,8,15,10,14,4,3,18,9,5,0,11,19,12,2,20,1,13,7,16};
  ...
  //  private static final int [] shsf8Order= new int [] {13,7,6,4,0,9,14,11,3,1,16,5,17,15,18,8,2,12,10};
    ...
    public static int[] getShsf5MinimalOrder(){
        return shsf5MinimalOrder;
    }
    public static int[] getShsf5MinimalOrder2(){
        return shsf5MinimalOrder2;
    }
    ...
    public static int[] getEnrollmentViewMinWBdateSHSWStrandOrder() {
        return enrollmentViewMinWBdateSHSWStrandOrder;
    }
    ...
    public static int[] getShsf5FullOrder() {
        return shsf5FullOrder;
    }
    ...
    public static int[] getShsf9Order() {
        return shsf9Order;
    }
