...
public class login extends javax.swing.JFrame implements java.lang.Runnable  {
    ...
    private void initComponents() {
        ...
        logo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mahPackage2/icons/logs.png"))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, 360, 120));
        ...
        enroll.setFont(new Font("Poppins", Font.BOLD, 16));
        enroll.setForeground(Color.BLACK);
        enroll.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        enroll.setText("ENROLLMENT SYSTEM");
        getContentPane().add(enroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, 360, 30));
        ...
        back.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mahPackage2/icons/final1.png"))); // NOI18N
        getContentPane().add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1030, 500));

        contactUs.setText("Help");

        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mahPackage2/icons/icons8-mail-20.png"))); // NOI18N
