...
public class myVariables {
    ...
    private static int [] enrollmentViewOrder = new int [] {17,7,3,0,9,10,1,5,8,11,4,2,19,18,6,13,14,15,16,12};
    ...
    private static int [] shsf1Order= new int [] {18,11,5,20,0,9,12,1,8,21,13,23,4,10,3,7,17,14,2,15,6,19,16,22};
