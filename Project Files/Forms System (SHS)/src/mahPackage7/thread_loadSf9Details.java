 ...
 */
public class thread_loadSf9Details extends SwingWorker<String, Object>{
    ...
    private JTextField tfEvaluatuion;
    ...
    public thread_loadSf9Details(JTable [] tablesToUse,String [] stringsToUse,JTextField [] textFieldsToUse,JButton [] buttonsToUse,boolean [] booleansToUse) {
        ...
        tfEvaluatuion = textFieldsToUse[2];
                ...
                if(incCount == 0){
                    if(failedCount <= 0){
                        if(gwa >= 75f){
                            ...
                            tfEvaluatuion.setText("PROMOTED");
                        }else{
                            tfEvaluatuion.setText("RETAINED");
                            //rbRetained.setSelected(true);
                        }
                    }else{
                        if(failedCount <= 2){
                            tfEvaluatuion.setText("CONDITIONAL");
                    ...
                    tfEvaluatuion.setText("INCOMPLETE");
